                        ...
                        <li class="col-xs-6 col-lg-3">
                            <div class="panel">
                                ...
                                <div class="panel-footer text-center">
									...
									<button type="button" class="btn btn-warning" ><a data-toggle="modal" data-target="#myModal"><i class="fa fa-share-square-o"></i>share</a></button>
                                </div>
                            </div>
                        </li>
								...
								<div class="modal-content">
									<div class="modal-header">
								  	...
								  	<div class="modal-body">
                                        ...
                                        <form action="<?=base_url()?>index.php/Dashboard/autoCompleteEmails" method="get">
                                            <label>E-Mail</label>
                                            <input class="form-control email" name="txtEmail" id="txtEmail"  placeholder="email@you.com" type="text">
                                        </form>
